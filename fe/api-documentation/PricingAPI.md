...
| Method | URL                                            | Action                   |
| ------ | ---------------------------------------------- | ------------------------ |
| POST   | `/api/pricing/base-price`                      | SetBasePrice             |
| GET    | `/api/pricing/base-price`                      | GetBasePrice             |
| GET    | `/api/pricing/base-prices/hotel/{hotelId}`     | GetBasePricesByHotel     |
| POST   | `/api/pricing/day-of-week-price`               | SetDayOfWeekPrice        |
| POST   | `/api/pricing/day-of-week-prices/bulk`         | SetBulkDayOfWeekPrices   |
| GET    | `/api/pricing/day-of-week-prices`              | GetDayOfWeekPrices       |
| DELETE | `/api/pricing/day-of-week-price`               | RemoveDayOfWeekPrice     |
| POST   | `/api/pricing/date-range-price`                | CreateDateRangePrice     |
| PUT    | `/api/pricing/date-range-price/{id}`           | UpdateDateRangePrice     |
| DELETE | `/api/pricing/date-range-price/{id}`           | DeleteDateRangePrice     |
| GET    | `/api/pricing/date-range-price/{id}`           | GetDateRangePriceById    |
| GET    | `/api/pricing/date-range-prices`               | GetDateRangePrices       |
| POST   | `/api/pricing/surcharge-rule`                  | CreateSurchargeRule      |
| PUT    | `/api/pricing/surcharge-rule/{id}`             | UpdateSurchargeRule      |
| DELETE | `/api/pricing/surcharge-rule/{id}`             | DeleteSurchargeRule      |
| GET    | `/api/pricing/surcharge-rules/hotel/{hotelId}` | GetSurchargeRulesByHotel |
| POST   | `/api/pricing/discount-rule`                   | CreateDiscountRule       |
| PUT    | `/api/pricing/discount-rule/{id}`              | UpdateDiscountRule       |
| DELETE | `/api/pricing/discount-rule/{id}`              | DeleteDiscountRule       |
| GET    | `/api/pricing/discount-rule/{id}`              | GetDiscountRuleById      |
| GET    | `/api/pricing/discount-rules`                  | GetDiscountRules         |
| GET    | `/api/pricing/discount-code/validate`          | ValidateDiscountCode     |
| GET    | `/api/pricing/overview`                        | GetPricingOverview       |
| POST   | `/api/pricing/calculate`                       | CalculatePrice           |
...
- URL: `/api/pricing/base-prices/hotel/{hotelId}`
- Method: `GET`
...
- URL: `/api/pricing/day-of-week-price`
- Method: `POST`
...
- URL: `/api/pricing/day-of-week-prices/bulk`
- Method: `POST`
...
- URL: `/api/pricing/day-of-week-prices`
- Method: `GET`
...
- URL: `/api/pricing/date-range-price`
- Method: `POST`
...
- URL: `/api/pricing/date-range-price/{id}`
- Method: `PUT`
...
- URL: `/api/pricing/date-range-prices`
- Method: `GET`
...
- URL: `/api/pricing/surcharge-rule`
- Method: `POST`
...
- URL: `/api/pricing/surcharge-rule/{id}`
- Method: `PUT`
...
- URL: `/api/pricing/surcharge-rules/hotel/{hotelId}`
- Method: `GET`
...
- URL: `/api/pricing/discount-rule/{id}`
- Method: `PUT`
...
- URL: `/api/pricing/discount-rules`
- Method: `GET`
...
- URL: `/api/pricing/discount-code/validate`
- Method: `GET`
...
export interface SetBasePriceDto {
  hotelId: string;
  roomTypeId: string;
  price: number;
}
...
export interface SetDayOfWeekPriceDto {
  hotelId: string;
  roomTypeId: string;
  dayOfWeek: number;
  price: number;
...
export interface BulkDayOfWeekPriceDto {
  hotelId: string;
  roomTypeId: string;
  dayPrices: DayPriceDto[];
}
export interface DayOfWeekPriceDto {
  id: string;
  hotelId: string;
  roomTypeId: string;
  roomTypeName: string;
...
export interface CreateDateRangePriceDto {
  hotelId: string;
  roomTypeId: string;
  startDate: string;
  endDate: string;
...
export interface UpdateDateRangePriceDto {
  startDate: string;
  endDate: string;
  price: number;
  description?: string;
}
export interface DateRangePriceDto {
  id: string;
  hotelId: string;
  roomTypeId: string;
  roomTypeName: string;
...
export interface DateRangePriceQueryParams {
  hotelId?: string;
  roomTypeId?: string;
  startDate?: string;
  endDate?: string;
...
export interface CreateSurchargeRuleDto {
  hotelId: string;
  surchargeType: number;
  amount: number;
  isPercentage: boolean;
}
export interface UpdateSurchargeRuleDto {
  amount: number;
  isPercentage: boolean;
}
export interface SurchargeRuleDto {
  id: string;
  hotelId: string;
  surchargeType: number;
  surchargeTypeName: string;
...
export interface DiscountRuleQueryParams {
  hotelId?: string;
  code?: string;
  isActive?: boolean;
  onlyValid?: boolean;
