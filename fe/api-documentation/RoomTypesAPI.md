...
| Method | URL                                  | Action              |
| ------ | ------------------------------------ | ------------------- |
| POST   | `/api/room-types`                    | CreateRoomType      |
| PUT    | `/api/room-types/{id}`               | UpdateRoomType      |
| DELETE | `/api/room-types/{id}`               | DeleteRoomType      |
| GET    | `/api/room-types/{id}`               | GetRoomTypeById     |
| GET    | `/api/room-types/{id}/details`       | GetRoomTypeDetails  |
| GET    | `/api/room-types`                    | GetRoomTypes        |
| GET    | `/api/room-types/by-hotel/{hotelId}` | GetRoomTypesByHotel |
| GET    | `/api/room-types/{id}/can-delete`    | ValidateDelete      |

---

## Create Room Type

- Endpoint URL: `/api/room-types`
- HTTP Method: `POST`
...
```json
{
  ...
  "data": {
    ...
    "description": "Spacious king room with city view",
    "amenities": [
      { "id": "4f6a0f4d-96fb-4e6b-8c98-7b6f1d9a1111", "name": "Wi-Fi" }
    ],
    "images": ["https://cdn.example.com/rooms/deluxe-king.jpg"],
    "roomCount": 10,
    "canDelete": true,
...
- Endpoint URL: `/api/room-types/{id}`
- HTTP Method: `PUT`
...
- Endpoint URL: `/api/room-types/{id}/details`
- HTTP Method: `GET`
...
- Endpoint URL: `/api/room-types/by-hotel/{hotelId}`
- HTTP Method: `GET`
...
- Endpoint URL: `/api/room-types/{id}/can-delete`
- HTTP Method: `GET`
